...
export default function Buttons(props) {
  ...
  if (props.children === "SPLIT") {
    return (
      <button onClick="SpltClick" className={props.className}>
        {props.children}
      </button>
    );
    ...
    return (
      <button onClick="SellClick" className={props.className}>
        {props.children}
      </button>
    );
  } else if (props.children === "CANCEL SELL") {
    return (
      <button onClick="CancelSellClick" className={props.className}>
        {props.children}
      </button>
    );
    ...
    return (
      <button onClick="joinClick" className={props.className}>
        {props.children}
      </button>
    );
